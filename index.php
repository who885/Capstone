...
<div class="column">
<div class="article_1">
  <a href="Art_1.php">  <img class="art_1_img" src="<?php echo $articles4->thumb_link; ?>" alt="" >
    <div class="center">
    <h2>Article_1</h2>
    <div class="content1">
...
<div class="column">
<div class="article_1">
  <a href="Art_2.php">  <img class="art_1_img" src="<?php echo $articles2->thumb_link; ?>" alt="">
    <div class="center">
    <h2>Article_2</h2>
    <div class="content2">
...
<div class="article_3">
  ...
  <a href="Art_4.php">  <img class="art_3_img" src="<?php echo $articles->thumb_link; ?>" alt="">
    <div class="center3">
    <h2>Article_4</h2>
    <div class="content3">
...
<div class="calendar">
   ...
   <div class="container">
     <div class="image_1">
         <a href="Art_5.php"> <img   src="<?php echo $articles3->thumb_link; ?>" alt=""/> </a>
     </div>
     <div class="image_2" >
     ...
     <div class="image_4">
      <a href="Art_8.php"> <img src="<?php echo $articles->thumb_link; ?>" alt=""/> </a>
     </div>
   </div>
</div>
  </body>
